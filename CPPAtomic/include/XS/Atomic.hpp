...
namespace XS
{
    ...
    class Atomic
    {
        private:
            ...
            template< class _U_ > struct HasModuloAssignmentOperator:               public std::integral_constant< bool, TrivialValueIsArithmetic<         _U_ >::value || XS::TypeTraits::HasModuloAssignmentOperator<              _U_, _U_ &, const _U_ & >::value > {};
            ...
            template< class _U_ > struct HasModuloOperator:                         public std::integral_constant< bool, TrivialValueIsArithmetic<         _U_ >::value || XS::TypeTraits::HasModuloOperator<                        _U_, _U_,   const _U_ & >::value > {};
